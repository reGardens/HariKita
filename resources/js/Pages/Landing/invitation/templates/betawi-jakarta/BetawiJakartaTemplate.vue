    ...
    <div class="betawi-jakarta-template" :style="themeStyles">
        ...
        <img src="/assets/templates/betawi-jakarta/bunga-kiri-atas/Lapisan 7.png" alt="" class="bunga-layer bunga-layer-7" /> -->
            ...
            >
                ...
                <div class="betawi-umbrella-top" aria-hidden="true">
                    ...
                    >
                        <g>
                            ...
                            <!-- Canopy -->
                            <path
                                d="M30,70 Q100,20 170,70 Z"
                                fill="var(--betawi-accent)"
                                opacity="0.8"
                            />
                            <path
                                d="M50,70 Q100,30 150,70 Z"
                ...
                <div
                    class="betawi-lantern-right color-pulse"
                    aria-hidden="true"
                >
                    <svg
                        viewBox="0 0 30 50"
                ...
                <div class="relative z-10">
                    ...
                    <h1
                        class="betawi-title mb-4 text-4xl leading-tight md:text-6xl"
                    >
                        {{ groomDisplayName }}
                        <span class="mx-2 block md:inline betawi-ampersand"
                            >&</span
                        >
                        {{ brideDisplayName }}
                    </h1>
            ...
            />
            <CountdownSection
                :target-date="firstEventDate"
                :theme-colors="settings?.themeColors"
            />
            <LoveStorySection
                v-if="settings?.loveStory?.length"
                :love-story="settings.loveStory"
                :theme-colors="settings?.themeColors"
            />
            <GallerySection
                :media="media"
                :gallery-layout="settings?.galleryLayout"
                :theme-colors="settings?.themeColors"
            />
...
const primaryColor = computed(
    () => props.settings?.themeColors?.primary || "#CC2200",
);
const secondaryColor = computed(
    () => props.settings?.themeColors?.secondary || "#FF6633",
);
const accentColor = computed(
    () => props.settings?.themeColors?.accent || "#FFD100",
);
...
function openInvitation() {
    ...
    setTimeout(() => {
        const next =
            document.querySelector(".betawi-cover")?.nextElementSibling;
