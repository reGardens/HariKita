    ...
    >
        ...
        >
            <div class="flex items-center gap-2">
                ...
                />
                <span
                    class="text-xs font-semibold tracking-wider uppercase text-white/90"
                    >Pratinjau Tema</span
                >
            </div>
            <a
        ...
        >
            <div class="max-w-md text-center">
                ...
                <p class="text-sm text-gray-500">
                    Template undangan belum dikonfigurasi. Silakan hubungi
                    admin.
                </p>
            </div>
        </div>
...
async function loadData() {
    ...
    try {
        const [coupleData, eventsData, settingsData, mediaData] =
            await Promise.all([
        ...
        activeTemplateRecord.value =
            templatesList.find((t) => t.id === templateId) || null;
        ...
        error.value =
            err?.message ||
            "Gagal memuat data undangan. Silakan coba lagi nanti.";
    } finally {
        loading.value = false;
    }
}
