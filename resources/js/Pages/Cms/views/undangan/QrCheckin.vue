            ...
            <div class="section-header">
                ...
                <div>
                    ...
                    <p class="section-desc">
                        Kelola check-in tamu dengan QR Code personal
                    </p>
                </div>
            </div>
            ...
            <div class="field-group">
                <div class="toggle-row">
                    ...
                    <button
                        type="button"
                        class="toggle-btn"
                        :class="{ 'toggle-btn--on': form.notifyAdmin }"
                        @click="form.notifyAdmin = !form.notifyAdmin"
                    >
                        <span
                            class="toggle-thumb"
                            :class="{ 'toggle-thumb--on': form.notifyAdmin }"
                        ></span>
                    </button>
                </div>
            </div>
            ...
            >
                ...
                >
                    ...
                    <div v-if="form.enabled">
                        <div
                            class="preview-qr-box"
                            :style="{
                                background: form.bgColor,
                                borderColor: form.fgColor,
                                color: form.fgColor,
                            }"
                        >
                            {{ form.style === "dots" ? "⚫⬛" : "▩" }}
