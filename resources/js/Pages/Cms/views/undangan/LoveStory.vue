    ...
    <div class="section-layout">
        ...
        <div class="section-preview">
            ...
            >
                ...
                >
                    <div class="preview-couple" style="color: #9d174d">
                        Love Story
                    </div>
                    <div
                    ...
                    <div class="preview-timeline">
                        ...
                        >
                            <div
                                class="preview-story-dot"
                                style="background: #ec4899"
                            ></div>
                            <div class="preview-story-text">
                                <div class="preview-story-date">
                                    {{ item.emoji || "💕" }}
                                    {{ item.date || "Tanggal" }}
                                </div>
                                <div
                                    class="preview-story-title"
                                    style="color: #9d174d"
                                >
                                    {{ item.title || "Judul Momen" }}
                                </div>
                                <div
                                    v-if="item.story"
                                    style="
...
<style scoped>
.story-block {
    border: 1px solid var(--border, #fce7f3);
