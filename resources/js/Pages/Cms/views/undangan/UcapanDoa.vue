    ...
    <div class="section-layout">
            ...
            <div class="section-header">
                ...
                <div>
                    ...
                    <p class="section-desc">
                        Buku tamu digital untuk ucapan dan doa dari tamu
                    </p>
                </div>
            </div>
            ...
            <div class="field-group">
                <div class="toggle-row">
                    ...
                    <button
                        type="button"
                        class="toggle-btn"
                        :class="{ 'toggle-btn--on': form.moderated }"
                        @click="form.moderated = !form.moderated"
                    >
                        <span
                            class="toggle-thumb"
                            :class="{ 'toggle-thumb--on': form.moderated }"
                        ></span>
                    </button>
                </div>
            </div>
        ...
        <div class="section-preview">
            ...
            >
                ...
                >
                    <div class="preview-couple" style="color: #581c87">
                        💬 Ucapan & Doa
                    </div>
                    <div
                    ...
                    <div v-if="form.enabled">
                        ...
                        >
                            ...
                            >
                                {{ form.placeholder || "Tulis ucapan Anda..." }}
                            </div>
                            <button
                        ...
                        <!-- Sample cards -->
                        <div
                            v-for="w in sampleWishes"
                            :key="w.name"
                            class="preview-wish-card"
                            :style="{
                                background: form.cardBg,
                                borderColor: form.cardBg,
                            }"
                        >
                            <div
                                class="preview-wish-name"
                                :style="{ color: form.nameColor }"
                            >
                                {{ w.name }}
                            </div>
...
const sampleWishes = [
    ...
    {
        name: "Bapak Ahmad",
        msg: "Selamat menempuh hidup baru, semoga bahagia selalu!",
    },
];
