                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="mt-1 text-sm text-amber-700">
                            Ditemukan data pernikahan dari versi sebelumnya.
                            Anda dapat memigrasikan data tersebut ke sistem
                            baru.
                        </p>
                    ...
                    <form @submit.prevent="handleCreate" class="space-y-4">
                        ...
                        <div>
                            ...
                            <p v-else class="mt-1 text-xs text-gray-500">
                                Huruf kecil, angka, dan tanda hubung. Minimal 3
                                karakter.
                            </p>
                        </div>
...
const canCreate = computed(() => {
    return (
        form.value.label.trim() && form.value.slug.trim() && !slugError.value
    );
});
...
async function executeMigration() {
    ...
    try {
        ...
        migrationError.value =
            error.message || "Terjadi kesalahan saat migrasi";
    } finally {
